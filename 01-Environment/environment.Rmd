...
```{r echo=FALSE, purl=F}
xfun::embed_file('C://ocean5098//01-Read_excel//reef_fish.xlsx')
```
...
read_excel('C://ocean5098//01-read_excel//reef_fish.xlsx') # automatically print on my screen
fish<-read_excel('C://ocean5098//01-read_excel//reef_fish.xlsx') # store my table in an object called `fish`
...
fish<-read.table('C://ocean5098//01-read_excel//reef_fish.txt', header=T, sep='\t', dec='.') 
```
...
fish<-read.table ("C://ocean5098//01-Read_excel//reef_fish.txt",header = TRUE,sep="\t", dec=".")# long version
fish<-read.table("C://ocean5098//01-Read_excel//reef_fish.txt", TRUE, "\t",".")# short version
```
